...
export const projects: readonly Project[] = [
  {
    ...
    architecture: ['Cliente', 'BunkerWeb WAF / reverse proxy', 'WordPress', 'MariaDB'],
  ...
  },
  {
    ...
    technologies: ['Angular 22', 'TypeScript', 'SCSS', 'Angular Router', 'SSR / prerendering'],
    architecture: [
      'Frontend Angular',
    ...
    architectureDescription:
      'La evolución se realizará por fases. Los pasos posteriores al contenido representan el roadmap del proyecto y no tecnología actualmente implementada.',
    ...
    roadmap: {
      implemented: [
        ...
        'Contact',
        'Página 404',
        'Datos de proyectos tipados localmente',
        'Tests',
        'Build funcional',
        'Git',
        'GitHub',
